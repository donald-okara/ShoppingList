            ...
            items(itemsByCategory.keys.toList()) { category ->
                Column(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Subtotal: ${categorySubtotals[category]}",
...
private fun InventoryItem(
    ...
    Card(
        modifier = modifier.fillMaxWidth().padding(dimensionResource(R.dimen.padding_small)).width(250.dp),
...
//                bottomEnd = 64.dp
//            ),
//            containerColor = MaterialTheme.colorScheme.primary, // Adjust transparency ,
//            modifier = Modifier,
//
//            ) {
//            Icon(
...
fun HomeBodyPreview() {
    InventoryTheme {
        HomeBody(listOf(
            Item(1, "Game", 100.0, 20, "Electronics"), Item(2, "Pen", 200.0, 30, "Electronics"), Item(3, "TV", 300.0, 50, "Electronics")
        ), onItemClick = {})
    }
}
